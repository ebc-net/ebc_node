...
class EbcNode : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:config.EbcNode) */ {
 public:
  ...
  inline EbcNode* New() const PROTOBUF_FINAL { return New(NULL); }

  EbcNode* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_msg_2eproto::InitDefaultsEbcNodeImpl();
};
// -------------------------------------------------------------------
...
class EbcNodes : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:config.EbcNodes) */ {
 public:
  ...
  inline EbcNodes* New() const PROTOBUF_FINAL { return New(NULL); }

  EbcNodes* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_msg_2eproto::TableStruct;
  friend void ::protobuf_msg_2eproto::InitDefaultsEbcNodesImpl();
};
// -------------------------------------------------------------------
...
class EbcMsg : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:config.EbcMsg) */ {
 public:
  ...
  inline EbcMsg* New() const PROTOBUF_FINAL { return New(NULL); }

  EbcMsg* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_msg_2eproto::TableStruct;
  friend void ::protobuf_msg_2eproto::InitDefaultsEbcMsgImpl();
};
// ===================================================================
...
inline void EbcMsg::set_allocated_msg(::std::string* msg) {
  ...
  if (msg != NULL) {
    set_has_msg();
    body_.msg_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
        msg);
  }
...
inline ::config::EbcNodes* EbcMsg::mutable_nodes() {
  if (!has_nodes()) {
    clear_body();
    set_has_nodes();
    body_.nodes_ = new ::config::EbcNodes;
  }
...
template <> struct is_proto_enum< ::config::MsgType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::config::MsgSubType> : ::google::protobuf::internal::true_type {};
